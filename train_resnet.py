...
def train_model(model_save_path, fig_save_path, transfer):
    ...
    if transfer:
        baseline_resnet_50_model = models.build_resnet50_transfer()
    else:
        baseline_resnet_50_model = models.build_resnet50_full()
    ...
    baseline_resnet_50_model.compile(optimizer='adam',
                            loss=tf.losses.CategoricalCrossentropy(), 
                            metrics=METRICS)
    history = baseline_resnet_50_model.fit(
    train_ds,
    ...
    return baseline_resnet_50_model
